...
def list_search(self):
    ...
    gccs = get_choix_calcul_search(self) 
    print "choix calcul : ", self.choix_calcul, gccs # to be removed
    ...
    # Penser à virer les Fast et PU de la liste Full
    ...
    for items in liste_fichiers_1:
        print items
    print '-----'
    for items in liste_fichiers_3:
        print items
