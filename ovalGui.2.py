...
from fonctions import cmd_test, liste, cmd_folder_creation, get_collection_list, get_choix_calcul, clean_files, copy_files, cmd_relval, cmd_listeRECO, cmd_listeDQM, list_search
...
#        self.QGBox32.setMinimumHeight(150)
        ...
        self.QGBox32.setLayout(qform32)
...
#        self.lineedit3.setVisible(False) # new
    ...
    def liste4(self):
        ...
        self.quelclient_m(to_transmit)
        
    def quelclient_m(self, to_transmit):
        ...
        for items in to_transmit[2]:
            self.quelclient.TextEdit.append(items)
